...
//    func searchGameData(searchString: String){
////        let stringAPI = gameManager.games[gameindex].gameAPIstring
//        //let jsonData = try NSData(contentsOfFile: path, options: NSDataReadingOptions.DataReadingMappedIfSafe)
//        let jsonData = NSData(contentsOfURL: NSURL.init(string: "http://www.giantbomb.com/api/search/&query=" + searchString + "/?api_key=ac905e94dc4133129b73939d35fa7a4f1b3e94c7&format=json&resources=game")! )
//        do {
//            let jsonResult: NSDictionary = try NSJSONSerialization.JSONObjectWithData(jsonData!, options: NSJSONReadingOptions.MutableContainers) as! NSDictionary
//            if let dict = jsonResult as? [String: AnyObject] {
//                //print(dict["results"]!["name"])
